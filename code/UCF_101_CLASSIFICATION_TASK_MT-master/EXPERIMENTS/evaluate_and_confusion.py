...
def evaluate(file_patern_labels, file_patern_ids, path_to_output_representation, debug=False):
	...
	for unique_id in unique_ids:
		...
		for rnk in xrange(min(len(class_counts), max_rank)):
			if( class_counts[rnk][1] == labels_true_curr_id[0]):
							
				acc_voting +=1
				break
			
		confusion[labels_true_curr_id[0], class_counts[0][1]] += 1  
		#confusion[labels_true_curr_id[0], labels_true_curr_id[0]]+= 1  
		#Sum. Posteriors
